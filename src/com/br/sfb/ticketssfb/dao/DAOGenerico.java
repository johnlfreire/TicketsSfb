...
import com.br.sfb.ticketssfb.exceptions.CannotDeleteException;
import com.br.sfb.ticketssfb.modelo.IModelo;
import com.br.sfb.ticketssfb.util.HibernateUtil;
...
public abstract class DAOGenerico {
    ...
    protected static final Logger logger = Logger.getLogger("sistemaarpen.dao");
    ...
    public void adicionar(IModelo m) {
        ...
        if(ex.getMessage().equals("could not insert: [sistemamalling.modelo.ModeloCartorio]")){
        TrayNotification tray = new TrayNotification();
        tray.setTitle("CNJ já existe!");
        tray.setMessage("O sistema apresentou um erro ao salvar a solicitação");
